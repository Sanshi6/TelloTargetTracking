...
def parse_args():
    ...
    args for fc testing.
    """
    parser = argparse.ArgumentParser(description='PyTorch SiamPRN Tracking Test')
    parser.add_argument('--arch', default='SiamRPNRes22', type=str, help='backbone architecture')
    parser.add_argument('--resume', default='/home/yl/Desktop/SiamDW-ori/pth/CIResNet22_RPN.pth', type=str, help='pretrained model')
    parser.add_argument('--video', default='/home/yl/Desktop/SiamDW-ori/video/Screenrecording_20220930_195115.mp4', type=str, help='video file path')
...
def track_video(tracker, model, video_path, init_box=None):
    ...
    if init_box is not None:
        ...
        while True:
            ...
            target_sz = np.array([w, h])
            print(target_pos)
            Aero[0] = target_sz[0] * target_sz[1]
    ...
    while True:
        ...
        Aero[1] = state['target_sz'][0] * state['target_sz'][1]
        print(state['target_pos'])
        # if Aero[0] - Aero[1] > 10000:
        #     print("self.move_forward(0.2)")
        # if Aero[1] - Aero[0] > 10000:
        #     print("self.move_backward(0.2)")
